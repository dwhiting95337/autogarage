...
//char* filename="C:\\Users\\Sam Vargas\\Desktop\\Senior Project\\shit.jpg";//This will grap photo from the camera
   char* filename="C:\\Users\\Sam Vargas\\Desktop\\Senior Project\\Senior Project\\test1.jpg";//This line is for 
	//char* filename="C:\\Users\\Sam Vargas\\Desktop\\car4.ppm";//This line is for 
    ...
    for(int i=0; i< posible_regions.size(); i++)
    {
		...
		{	
			...
			cv:: Mat original = cv::imread("C:\\Users\\Sam Vargas\\Desktop\\Senior Project\\check_size1.jpg");
			cv::resize(img, img,original.size());
			imshow("image_2",img);
			imwrite("C:\\Users\\Sam Vargas\\Desktop\\Senior Project\\check_size2.jpg",img);
			imwrite("C:\\Users\\Sam Vargas\\Desktop\\Senior Project\\tiff.tif",img);
			correct_region=i;
    ...
    for(int i=0; i< plates.size(); i++){
        Plate plate=plates[i];//C:\\Users\\Samuel Vargas\\Desktop\\Plates\\crop.jpg
			...
			//getting the plate image
				...
				imwrite("C:\\Users\\Sam Vargas\\Desktop\\Senior Project\\crop.jpg",image_roi);
				imwrite("C:\\Users\\Sam Vargas\\Desktop\\Senior Project\\notcrop.jpg",posible_regions[correct_region].plateImg);
				...
				//does that for you
				Mat needed=imread("C:\\Users\\Sam Vargas\\Desktop\\Senior Project\\crop.jpg");
				cv::resize(needed, needed,original.size());//actual resizing portion
				
				//Rect roi1(5,25, 160, 50);
				Rect roi1(0,25, 135, 37);//x cord, y cord, width, height  This crops out the image
				Mat crops = cropimage(roi1);//puts image into Mat type
				...
				//pass in grey image
				imwrite("C:\\Users\\Sam Vargas\\Desktop\\Senior Project\\bw.jpg",img_bw);
...
//Tesseract Part
 ...
 cout<<"File name:";
 char image[256]="plate.jpg";//="C:\\Users\\Sam Vargas\\Desktop\\Senior Project\\tiff7.jpg";
 //cin>>image;
 ...
 //End of Tesseract part
        ...
        string licensePlate=text_out.string();
...
bool take_picture()
{
	...
	Mat CARIMAGE;
	Mat sizing=imread("C:\\Users\\Sam Vargas\\Desktop\\Senior Project\\Senior Project\\california.jpg");
	...
	while(1){
		...
		cvWaitKey(5000);
			...
			capture>>CARIMAGE;
		//	imwrite("C:\\Users\\Sam Vargas\\Desktop\\beforeresize.jpg",CARIMAGE);
			resize(CARIMAGE,CARIMAGE,sizing.size());
			//return 0;
			imwrite("C:\\Users\\Sam Vargas\\Desktop\\Senior Project\\shit.png",CARIMAGE);//chose whichever you like
			imwrite("C:\\Users\\Sam Vargas\\Desktop\\Senior Project\\shit.jpg",CARIMAGE);
			leave_while=true;
			break;
