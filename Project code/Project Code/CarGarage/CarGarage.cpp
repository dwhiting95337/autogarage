...
{
	 Mat large = imread("C:\\Users\\Tyler\\Desktop\\nocar.jpg",1);
	 Mat small = imread("C:\\Users\\Tyler\\Desktop\\A.jpg",1);
	 small.copyTo(large(cv::Rect(0,0,small.cols, small.rows)));
	 imshow("output",large);
	 waitKey(0);
}
*/
...
int main( int argc, const char** argv )
{
    ...
    Mat image1 = imread("C:\\Users\\Tyler\\Desktop\\nodriveway.png",1);
	Mat image;
	...
	string checkcas = "C:\\Users\\Tyler\\Documents\\Visual Studio 2012\\Projects\\CarGarage\\CarGarage\\checkcas.xml";//argv[2];
	...
	//{
		for(int i = 0;i<5;i++)
		{
			if(i==0)
			{
				string cas = "C:\\Users\\Tyler\\Documents\\Visual Studio 2012\\Projects\\CarGarage\\CarGarage\\checkcas.xml"; //argv[i];			
				detectcars.cascade_load(cas);            
				detectcars.findcars();
			}
			else if(i==1)
			{
				string cas = "C:\\Users\\Tyler\\Documents\\Visual Studio 2012\\Projects\\CarGarage\\CarGarage\\cas1.xml"; //argv[i];			
				detectcars.cascade_load(cas);            
				detectcars.findcars();
			}
			else if(i==2)
			{
				string cas = "C:\\Users\\Tyler\\Documents\\Visual Studio 2012\\Projects\\CarGarage\\CarGarage\\cas2.xml"; //argv[i];			
				detectcars.cascade_load(cas);            
				detectcars.findcars();
			}
			else if(i==3)
			{
				string cas = "C:\\Users\\Tyler\\Documents\\Visual Studio 2012\\Projects\\CarGarage\\CarGarage\\cas3.xml"; //argv[i];			
				detectcars.cascade_load(cas);            
				detectcars.findcars();
			}
			else if(i==3)
			{
				string cas = "C:\\Users\\Tyler\\Documents\\Visual Studio 2012\\Projects\\CarGarage\\CarGarage\\cas4.xml"; //argv[i];			
				detectcars.cascade_load(cas);            
				detectcars.findcars();
			}
		}
